...
parser.add_argument("--d_every", type=int, default=5, help="train the discriminator every d_every batches")
...
train_dataloader = DataLoader(
    TrainImageDataset("../My_dataset/single_channel_100000/%s" % opt.train_dataset_name, hr_shape=hr_shape, scale_factor = opt.scale_factor),                # change
...
val_dataloader = DataLoader(
    ValImageDataset("../My_dataset/single_channel_100000/%s" % opt.val_dataset_name, hr_shape=hr_shape, scale_factor = opt.scale_factor),                # change
